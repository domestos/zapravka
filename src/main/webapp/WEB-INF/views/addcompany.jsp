...
<body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Мої дії <span class="caret"></span></a>
              <ul class="dropdown-menu">
              	<li class="dropdown-header">Add</li>
                <li><a href="#">Додати компанію</a></li>
                <li><a href="#">Додати картрідж</a></li>
    ...
    <div class="jumbotron">
        ...
        <img class="img-responsive" align="center" alt="support cartridge" src='<c:url value="/resources/images/supportcartridge.jpg"/>' >
